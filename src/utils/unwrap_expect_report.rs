...
// TODO: rename trait to UnwrapExpectReportExt, name to unwrap_report and add expect_report.
...
pub trait UnwrapExpectReportExt<T> {
    ...
    /// Reports a disconnect if there is an error with a custom message, otherwise returns the value.
    ///
